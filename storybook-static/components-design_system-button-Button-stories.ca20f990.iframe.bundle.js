/*! For license information please see components-design_system-button-Button-stories.ca20f990.iframe.bundle.js.LICENSE.txt */
  ...
  [501],
  {
    ...
    "./src/components/design_system/button/Button.stories.tsx": (
      ...
      const __WEBPACK_DEFAULT_EXPORT__ = {
        ...
        Primary = {
          args: { children: "Button", size: "large", variant: "primary" },
        },
        Secondary = {
          args: { children: "Button", size: "large", variant: "secondary" },
        },
        Tertiary = {
          args: { children: "Button", size: "large", variant: "tertiary" },
        },
        PrimarySmall = {
          args: { children: "Button", size: "small", variant: "primary" },
        },
        SecondarySmall = {
          args: { children: "Button", size: "small", variant: "secondary" },
        },
        TertiarySmall = {
          args: { children: "Button", size: "small", variant: "tertiary" },
        },
        __namedExportsOrder = [
          "Primary",
          "Secondary",
      ...
      (Primary.parameters = {
        ...
        (TertiarySmall.parameters = {
          ...TertiarySmall.parameters,
          docs: {
            ...TertiarySmall.parameters?.docs,
            source: {
              originalSource:
                '{\n  args: {\n    children: "Button",\n    size: "small",\n    variant: "tertiary"\n  }\n}',
              ...TertiarySmall.parameters?.docs?.source,
            },
          },
        });
    },
