...
declare module 'zapatos/schema' {
  ...
  export namespace public {  
    export type Table = account.Table | cm_to_para.Table | migrations.Table | session.Table | student.Table | user.Table;
    export type Selectable = account.Selectable | cm_to_para.Selectable | migrations.Selectable | session.Selectable | student.Selectable | user.Selectable;
    export type JSONSelectable = account.JSONSelectable | cm_to_para.JSONSelectable | migrations.JSONSelectable | session.JSONSelectable | student.JSONSelectable | user.JSONSelectable;
    export type Whereable = account.Whereable | cm_to_para.Whereable | migrations.Whereable | session.Whereable | student.Whereable | user.Whereable;
    export type Insertable = account.Insertable | cm_to_para.Insertable | migrations.Insertable | session.Insertable | student.Insertable | user.Insertable;
    export type Updatable = account.Updatable | cm_to_para.Updatable | migrations.Updatable | session.Updatable | student.Updatable | user.Updatable;
    export type UniqueIndex = account.UniqueIndex | cm_to_para.UniqueIndex | migrations.UniqueIndex | session.UniqueIndex | student.UniqueIndex | user.UniqueIndex;
    export type Column = account.Column | cm_to_para.Column | migrations.Column | session.Column | student.Column | user.Column;
  
    export type AllBaseTables = [account.Table, cm_to_para.Table, migrations.Table, session.Table, student.Table, user.Table];
    export type AllForeignTables = [];
    export type AllViews = [];
    export type AllMaterializedViews = [];
    export type AllTablesAndViews = [account.Table, cm_to_para.Table, migrations.Table, session.Table, student.Table, user.Table];
  }
